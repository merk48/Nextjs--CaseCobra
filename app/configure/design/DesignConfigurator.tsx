...
export function DesignConfigurator({
  ...
  const phoneCasRef = useRef<HTMLDivElement>(null);

  const { startUpload } = useUploadThing("imageUploader");

  const saveConfigiguration = async () => {
    try {
      const {
        left: caseLeft,
        top: caseTop,
        width,
        height,
      } = phoneCasRef.current!.getBoundingClientRect();
  ...
  // const saveConfig = async ({ configId, color, model, material, finish }) => {};
